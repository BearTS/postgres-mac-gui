...
public struct Keychain: Sendable {
    ...
    public static let service = "dev.anujp.postgresmanager"
    ...
    public func set(password: String, cluster: String, role: String) throws {
        ...
        query[kSecAttrLabel as String] = "Postgres Manager — \(role)"
...
public struct PassFile: Sendable {
    ...
    public static func directory() -> String {
        ...
        return "\(home)/Library/Application Support/PostgresManager"
    }
