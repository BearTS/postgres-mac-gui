    ...
    private var installSection: some View {
        if model.brew == nil {
            VStack(alignment: .leading, spacing: 12) {
                ...
                Text("Dev Services installs Postgres through Homebrew. Install Homebrew first, then reopen this app.")
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                Text("Dev Services also finds installations from Postgres.app, the EDB installer, or anything on your PATH. If you just installed one, rescan.")
                    .font(.callout)
                    .foregroundStyle(.secondary)
